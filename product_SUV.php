...
<body class="w3-content" style="max-width:1200px">
    ...
    <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
        <div class="w3-container w3-display-container w3-padding-16">
            ...
            <div class="w3-round  w3-image" style="margin-left: -15px"><img src="Media/img/Logo.png" width="100%" /></div>
            </h3>
        </div>
    ...
    <header class="w3-bar w3-top w3-hide-large w3-black w3-xlarge">
        ...
        <div><img src="Media/img/Logo.png" width="100%"/></div>
    ...
    <div class="w3-main" style="margin-left:250px">
        ...
        <header class="w3-container w3-xlarge">
           <a href="index.php"><p class="w3-left">Danh Mục Xe SUV</p></a>
            <p class="w3-right">
       ...
       <div class="w3-content w3-display-container">
            <?php 
			$sql = "SELECT tblproducts.pID,tblproducts.pImg,tblproducts.pNew, tblproducts.cateID, img_main
    	    FROM tblproducts 
            INNER JOIN tblmf ON tblproducts.mafacID = tblmf.mfID
            INNER JOIN tblimg ON tblproducts.pImg = tblimg.iID WHERE cateID=1"	;
...
<!--                <p><a href="#jeans" class="w3-button w3-black w3-padding-large w3-large">SHOP NOW</a>-->
    ...
    <div class="w3-container w3-text-grey"> <p> Sản Phẩm </p> </div>
        <!-- Product grid -->
