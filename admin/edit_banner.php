...
$row1=mysql_fetch_assoc($kq1);	
	...
	{
		$hinh = $_POST["hinh"];
		$sql= "UPDATE `banner` SET `hinh`= '$hinh' WHERE `banner`.`idbn`=$idbn)";
		if(mysql_query($sql))
		{
...
<div class="container">
	...
	<form action="" method="post">
		...
		<tr>
			<td>Hình</td>
			<td><input value="<?php echo $row1["hinh"];?>" type="text" id="hinh" name="hinh"/><input onclick="BrowseServer('hinhanh:/','hinh')"  type="button" name="btnChonFile" id="btnChonFile" value="Chọn File" /></td>
