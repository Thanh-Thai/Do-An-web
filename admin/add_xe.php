...
if(isset($_POST["btn_Them"]))
{
	...
	$sql= "INSERT INTO 	tblproducts(pID,pName,pDescript,pYear,pColor,pPrice,pImg,pStatus,mafacID,cateID,pNew,pSale)
	VALUES (DEFAULT,'$name','$noidung','$year','$color','$price','Media/images/$hinhname','$status','$nsx_id','$theloai_id','$new','$sale')";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="add_xe.php">Thêm Xe</a></li>
		</ol>
	</div><!--/.row-->
	<div class="row">
			<form action="" method="post" enctype="multipart/form-data">
				<table>
					...
					<tr>
						<td>Nội dung</td>
						<td><textarea class="form-control" name="noidung" rows="10"></textarea></td>
					</tr>	
					<tr>
						<td>Năm Sản Xuất:</td>
					...
					<tr>
						<td>Hình: </td>
						<td>
							<input class="form-control" type="file" name="hinh"></td>
						</tr>		
						<tr>
						<td>Tình trạng:</td>
						<td>
